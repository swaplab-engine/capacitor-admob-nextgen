...
| **`retryInterval`**                    | <code>number</code>                                                                                                                                                                                                                                                                            | Minimum time (in milliseconds) before the next ad request is allowed. Prevents spam requests and invalid traffic bans. Default is 5000.                                                                                                |
| **`enableCapacitor8SafeAreaHandling`** | <code>boolean</code>                                                                                                                                                                                                                                                                           | Smart safe-area handling for Capacitor 8.5+. Prevents double padding on Android 14 and below with WebView &lt; 140. Set to true if using Capacitor 8.5+ with default edge-to-edge layout. Default is false for backward compatibility. |
